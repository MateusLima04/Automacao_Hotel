# 🏨 Automação de Cadastro de Hotéis
...
- Organização de números e tipos de hospedagem
...
1. Navegar pelo sistema de cadastro
2. Inserir informações automaticamente
...
```bash
git clone https://github.com/MateusLima04/Automacao_Hotel.git
